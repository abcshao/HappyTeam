              ...
              <section class="kuang">
                <header>
                  ...
                  <section>
                    ...
                    <router-link :to="{path:'/jifenshuoming'}" class="shuoming">积分说明</router-link>
                  </section>
                </header>
