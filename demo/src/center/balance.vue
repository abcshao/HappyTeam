        ...
        <section class="kuang">
          <header>
            ...
            <section>
              ...
              <router-link :to="{path:'/explain'}" class="shuoming">余额说明</router-link>
            </section>
          </header>
          ...
          <!--余额-->
          <p>
            <span class="top">0.00</span>
            <span class="bott">元</span>
          </p>

          <van-button type="primary" size="large" class="btn">提交</van-button>
        </section>
